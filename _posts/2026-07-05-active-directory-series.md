...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 16px; margin-top: 20px;">
  ...
  <!-- Phase 3 Card -->
  <a href="/posts/ad-phase-3-gpo/" style="text-decoration: none; color: inherit;">
    <div style="border: 1px solid #333; border-radius: 8px; padding: 18px; background-color: #1e1e2e;">
  ...
  <!-- Phase 4 Card -->
  <a href="/posts/ad-phase-4-resilience/" style="text-decoration: none; color: inherit;">
    <div style="border: 1px solid #333; border-radius: 8px; padding: 18px; background-color: #1e1e2e;">
      <h3 style="margin-top:0; color: #f38ba8;">Phase 4</h3>
      <p style="font-size: 0.9em; color: #cdd6f4;">Architecture Resilience</p>
    </div>
  </a>
